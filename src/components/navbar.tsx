...
import Link from "next/link";
import { ProfileDropdown } from "@/components/button-signin-signout";

interface NavbarProps {
  session: any; // сюда better-auth вернёт сессию
}
  ...
  return (
    <nav className="flex justify-between items-center p-4 bg-gray-900 text-white">
      ...
      <div className="flex items-center gap-4">
        {/* Если залогинен → показать dropdown */}
        {/* Если нет → показать Sign In */}
